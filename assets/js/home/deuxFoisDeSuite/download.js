document.getElementById('btn-download-deuxFoisDeSuite').addEventListener('click', function () {
    ...
    fetch(`/get-script-deuxFoisDeSuite?script_name=${encodeURIComponent(scriptName)}`)
        .then(response => {
            if (!response.ok) {
