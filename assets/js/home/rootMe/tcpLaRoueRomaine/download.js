document.getElementById('btn-download-tcpLaRoueRomaine').addEventListener('click', function () {
    ...
    fetch(`/get-script-tcpLaRoueRomaine?script_name=${encodeURIComponent(scriptName)}`)
        .then(response => {
            if (!response.ok) {
