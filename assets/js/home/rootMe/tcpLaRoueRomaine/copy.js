document.getElementById('copy-script-tcpLaRoueRomaine-btn').addEventListener('click', function () {
    const textarea = document.getElementById('script-content-show-tcpLaRoueRomaine');
    ...
    try {
        ...
        const toastEl = document.getElementById('copy-toast-tcpLaRoueRomaine');
