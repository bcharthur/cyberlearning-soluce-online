document.getElementById('copy-script-tcpChaineEncodee-btn').addEventListener('click', function () {
    const textarea = document.getElementById('script-content-show-tcpChaineEncodee');
    ...
    try {
        ...
        const toastEl = document.getElementById('copy-toast-tcpChaineEncodee');
