        ...
        .then(data => {
            ...
            if (data.status === 'success') {
                ...
                if (data.message && data.message.includes(" Could not connect to challenge")) {
                    ...
                    document.getElementById('script-output-tcpRetourAuCollege').innerHTML = `<strong>Erreur :</strong> Veuillez vous connecter d'abord sur la page du challenge en cliquant sur <strong><i class="fa-solid fa-globe"></i></strong>, la connexion doit être établie avant de pouvoir exécuter le script .`;
                }
            }
        })
        .catch((error) => {
