document.getElementById('btn-download-tcpRetourAuCollege').addEventListener('click', function () {
    ...
    fetch(`/get-script-tcpRetourAuCollege?script_name=${encodeURIComponent(scriptName)}`)
        .then(response => {
            if (!response.ok) {
